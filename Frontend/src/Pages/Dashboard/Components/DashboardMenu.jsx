        ...
        <div className="dashboard-menu-main">
            ...
            {userType ?
                <div className="dashboard-menu-options">
                    <div className="dashboard-menu-btns"><Link className="dashboad-menu-links">Home</Link></div>
                    <div className="dashboard-menu-btns"><Link className="dashboad-menu-links">My Events</Link></div>
                    <div className="dashboard-menu-btns"><Link className="dashboad-menu-links">Create Events</Link></div>
